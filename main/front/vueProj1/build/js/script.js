...
/* harmony import */ var _methods__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./methods */ "./src/js/methods.js");
...
var vm = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  computed: {
    ...
    getUserInfo: function getUserInfo() {
      return "<strong>name:</strong> ".concat(this.user.name, ", email: ").concat(this.user.email, ", tel: ").concat(this.user.tel);
    }
  },
  methods: {
    getUserInfoHtml: function getUserInfoHtml() {
      console.log('aaaa');
      return "<strong>name:</strong> ".concat(this.user.name, ", email: ").concat(this.user.email, ", tel: ").concat(this.user.tel);
    },
    setNumber: function setNumber(number, e) {
      this.number += number;
    ...
    addUser: function addUser() {
      var _this$userAdd = this.userAdd,
          user = _this$userAdd.user,
...
/***/ 0:
/*!*************************************************!*\
  !*** multi ./src/js/app.js ./src/js/methods.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! D:\OpenServer\domains\beetroot.local\main\front\vueProj1\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! D:\OpenServer\domains\beetroot.local\main\front\vueProj1\src\js\methods.js */"./src/js/methods.js");
